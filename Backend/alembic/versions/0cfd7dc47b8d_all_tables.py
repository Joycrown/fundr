...
Revision ID: 0cfd7dc47b8d
Revises: fbbb2c0fa931
Create Date: 2023-05-08 13:31:38.619974
...
revision = '0cfd7dc47b8d'
down_revision = 'fbbb2c0fa931'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('serial_no', 'id'),
    sa.UniqueConstraint('email'),
