...
Revision ID: d084d90f579f
Revises: 508a8b9d654c
Create Date: 2023-01-12 15:38:46.583694
...
revision = 'd084d90f579f'
down_revision = '508a8b9d654c'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('profit_share', sa.Integer(), nullable=False),
